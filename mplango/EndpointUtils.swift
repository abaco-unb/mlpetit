...
class EndpointUtils: AnyObject {
    ...
    static let SERVER_BASE = "http://server.maplango.com.br"//"http://localhost:10088/maplango/public"
    
    static let USER:String    = EndpointUtils.SERVER_BASE + "/user-rest"
    static let POST:String    = EndpointUtils.SERVER_BASE + "/post-rest"
    static let CARNET:String  = EndpointUtils.SERVER_BASE + "/image-rest"
    static let IMAGE:String   = EndpointUtils.SERVER_BASE + "/note-rest"
